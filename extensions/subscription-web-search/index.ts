...
const rowText = (value: unknown): string => (typeof value === "string" ? stripTerminalSequences(value).replace(/\p{Cc}/gu, " ") : "");
...
export const websearch = defineTool({
  name: "websearch",
  label: "Web Search",
  description: "Search the web and get back a ranked list of titles and URLs. Returns no page text: read a result with webfetch.",
